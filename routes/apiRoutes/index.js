    ...
    axios.get(`https://www.gasbuddy.com/home?search=${req.params.id}&fuel=1`)
        .then(response => {
            ...
            $(".GenericStationListItem__stationListItem___3Jmn4").each((i, element) => {
                ...
                result.logo = $(element).children(".GenericStationListItem__logoColumn___2oYl7").children(".StationBrandings__logoImages___1KnoP").children(".GenericStationListItem__logoImageContainer___2SVFN").children("noscript").children(".image__image___1ZUby").attr("src");
